...
function mapProps(state) {
  var loc = state.routing.locationBeforeTransitions;
  return {
    browserWarningEnabled: loc.query["browser-warning-enabled"] === "true",
    jsWarningEnabled: loc.query["js-warning-enabled"] === "true",
    base: state.base,
  ...
  _createClass(Application, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_components.injection.InjectionProvider, {
        ...
        "data-toggle-enabled": props.visible,
        enabled: props.navigationEnabled
      }, _react.default.createElement(_navigation.default, null, _react.default.createElement(_navigation.NavigationHeader, null, _react.default.createElement(_logo.default, null)), _react.default.createElement(_navigation.NavigationToolbar, null, _react.default.createElement("div", null), _react.default.createElement(_toggleSearch.default, null), _react.default.createElement(_indicator.default, null)))))), _react.default.createElement(StyledContentContainer, null, _react.default.createElement(StyledContent, null, props.browserWarningEnabled !== false && _react.default.createElement(StyledBrowserWarning, {
        navigationEnabled: props.navigationEnabled,
        ...
        symbol: "close"
      })))), props.jsWarningEnabled !== false && _react.default.createElement(StyledBrowserWarning, {
        navigationEnabled: props.navigationEnabled,
...
var StyledBrowserContainerClose = (0, _components.styled)(_components.Link).attrs({
  external: true
}).withConfig({
...
/******/ });
//# sourceMappingURL=client.5419fbfbdd79bacb92ec.js.map